...
# ---- Hyperparameter tuning (avoid overfitting, common issue with trees) ----
param_grid = {
...
plt.title(f"Titanic Survival Decision Tree (Test Accuracy: {test_acc:.2%})")
plt.tight_layout()
plt.savefig('/home/claude/titanic_tree.png', dpi=150, bbox_inches='tight')
print("\nTree plot saved.")
...
plt.title('Feature Importance - Titanic Survival Decision Tree')
