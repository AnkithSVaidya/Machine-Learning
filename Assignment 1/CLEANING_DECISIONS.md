...
| 2 | Cancellations | Dropped all lines whose `InvoiceNo` starts with C (about 9,300 lines) and matched them to the initial orders that were cancelled (about 7,000 lines). | They are reversals and returns, not completed sales. They are analysed separately for Q6. |
...
* Final clean completed-sales rows: 515,601.
